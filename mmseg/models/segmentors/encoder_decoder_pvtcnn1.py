...
#第二种第二阶段：使用resnet充当第二阶段
@SEGMENTORS.register_module()
class EncoderDecoder_Pvtcnn1(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 global_cfg=None,
                 pretrained=None):
        super(EncoderDecoder_Pvtcnn1, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(EncoderDecoder_Pvtcnn1, self).init_weights(pretrained)
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        with torch.no_grad():
            global_features=[]
            global_features.append(self.global_model.inference_seg_logits_feature1(img)[0].detach()) #截断，防止训练
            global_features.append(self.global_model.inference_seg_logits_feature1(img)[1].detach()) #截断，防止训练
            global_features.append(self.global_model.inference_seg_logits_feature1(img)[2].detach()) #截断，防止训练
            global_features.append(self.global_model.inference_seg_logits_feature1(img)[3].detach()) #截断，防止训练
