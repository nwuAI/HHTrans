...
class BIMLAHead(nn.Module):
    ...
    def forward(self, mla_p2, mla_p3, mla_p4, mla_p5):
        ...
        return torch.cat([head3, head4, head5], dim=1)#torch.Size([1, 128, 224, 224])
        # return head5



@HEADS.register_module()
class PVT_Head_Noise(BaseDecodeHead):
    ...
    def __init__(self, img_size=768, mla_channels=256, mlahead_channels=128,
        ...
        super(PVT_Head_Noise, self).__init__(**kwargs)
        ...
        self.global_features = nn.Sequential(
            nn.Conv2d(3 * self.mlahead_channels, self.mlahead_channels, 3, padding=1),
