...
def parse_args():
    ...
    # parser.add_argument('--globalconfig', type=str, default='../configs/bsds/EDTER_BIMLA_320x320_80k_bsds_bs_8pvtswin.py',
    ...
    # parser.add_argument('--config', type=str, default='../configs/bsds/EDTER_BIMLA_320x320_80k_bsds_bs_8pvt_swin_resnet34_3.py',
                        help='train local config file path')
    parser.add_argument('--checkpoint', type=str, default='../../EDTER-BSDS-VOC-StageII.pth',
                        help='the dir of local model')
    parser.add_argument('--global-checkpoint', type=str,
                        # default='../work_dirs/EDTER_BIMLA_320x320_80k_bsds_bs_8/iter_80000.pth',
                        default='../../EDTER-BSDS-VOC-StageI.pth',
    ...
    parser.add_argument(
        '--tmpdir', type =str, default='../work_dirs/edtertest',
